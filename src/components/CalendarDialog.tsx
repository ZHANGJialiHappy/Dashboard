  ...
  return (
    <div className="flex flex-wrap justify-center gap-3 items-center">
      ...
      <div className="card rounded-s-lg bg-base-100 shadow-xl">
        ...
        <input type="text" placeholder="From xxxx-xx-xx" className="input rounded-none text-sm border-0 border-b-2 h-5" />
        <input type="text" placeholder="To xxxx-xx-xx" className="input rounded-none text-sm border-0 border-b-2 h-5" />
        </div>
